...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Tidak Punya Akun? Buat Akun");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_username, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/undraw_sweet_home_dkhr-removebg-preview (1).png"))); // NOI18N
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        try{
            String sql = "SELECT * FROM admin WHERE username='"+txt_username.getText()+"'AND password='"
            ...
            if(rs.next()){
                if(txt_username.getText().equals(rs.getString("username"))
                    ...
                    new dashboardu().setVisible(true);
                }
            }else if(txt_username.getText().isEmpty() || txt_password.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Silahkan isi username/password");
            }else{
